      ...
      <div className="container mx-auto px-4 pt-40 pb-32">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Experience seamless communication with integrated whiteboard and
            code sharing capabilities. All in one powerful platform.
          </p>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600">
              Instant messaging with rich text formatting and file sharing
              capabilities.
            </p>
          </div>
          <div
          ...
          >
            ...
            <p className="text-gray-600">
              Collaborative drawing with multiple colors and tools for visual
              communication.
            </p>
          </div>
          <div
          ...
          >
            ...
            <p className="text-gray-600">
              Real-time code editor with syntax highlighting and collaborative
              editing.
            </p>
          </div>
        </div>
